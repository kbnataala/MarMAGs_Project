...
svg("/Thesis/work_package_3/Data_analysis/01_figures/04_library_figures/04_sovereibnity.svg", width = 12, height = 8)

# Generate and plot for SOVEREIGN1
sovereign_plot <- create_bar_plot(libs, "Sovereignity", "Top 10 Sovereignity by Frequency", top_n = 12)
print(sovereign_plot)
...
svg("/Thesis/work_package_3/Data_analysis/01_figures/04_library_figures/03_barplots_charts.svg", width = 20, height = 10)

# Step 4: Arrange with (a) and (b) tags in the upper‐left corner
grid.arrange(
  ocean_sea_plot +
    labs(tag="(c)") +
    theme(
      plot.tag.position = c(0, 1),      # (0,1) = top‐left
...
svg("/Thesis/work_package_3/Data_analysis/01_figures/04_library_figures/04_supp_barplots_charts.svg", width = 28, height = 24)
